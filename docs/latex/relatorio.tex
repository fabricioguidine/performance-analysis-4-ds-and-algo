...
All tests can be executed using scripts in the \texttt{tests/scripts/} directory:

\begin{itemize}
    \item \texttt{tests/scripts/test.sh} (Linux/Mac/Git Bash)
    \item \texttt{tests/scripts/test.bat} (Windows)
\end{itemize}

The test suite uses JUnit 4 framework and validates:
\begin{itemize}
    ...
    \item Performance tracking mechanisms
