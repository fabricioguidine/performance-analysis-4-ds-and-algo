...
The results from identifying the most frequent authors are in \texttt{output/outputPart2.txt}. Table \ref{tab:most-frequent-authors} presents the authors with the highest number of works in the dataset.
...
The results from the Red-Black tree experiments are in \texttt{output/outputInsertion.txt} and \texttt{output/outputSearch.txt}. Table \ref{tab:redblack-results} presents performance metrics for insertion and search operations.
...
\begin{tabular}{c c c c c}
    \toprule
    \textbf{Operations} & \makecell{\textbf{Insertion}\\\textbf{Time (ms)}} & \makecell{\textbf{Search}\\\textbf{Time (ms)}} & \makecell{\textbf{Insertion}\\\textbf{Comparisons}} & \makecell{\textbf{Insertion}\\\textbf{Swaps}} \\
    \midrule
...
The results from the B+ tree experiments with degree 2 are in \texttt{output/outputInsertion.txt} and \texttt{output/outputSearch.txt}. Table \ref{tab:bplus-d2-results} presents the performance metrics.
...
The results from the B+ tree experiments with degree 20 are in \texttt{output/outputInsertion.txt} and \texttt{output/outputSearch.txt}. Table \ref{tab:bplus-d20-results} presents the performance metrics.
...
\begin{itemize}
    ...
    \item Input sizes limited to values in the \texttt{input/input.txt} file
